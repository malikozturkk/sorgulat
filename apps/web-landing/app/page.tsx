...
import { Card } from '@sorgulat/ui-lib/card';
import { Code } from '@sorgulat/ui-lib/code';
  ...
  return (
    <main className={styles.main}>
      <div className={styles.description}>
        <p>
          sorgulat.com/&nbsp;
          <Code className={styles.code}>homepage</Code>
        </p>
        <div>
      ...
      <Link href="http://localhost:3023/uye-ol" className={styles.button} target={'_blank'}>
        Üye Ol
      </Link>
      <Link href="http://localhost:3023/giris" className={styles.button} target={'_blank'}>
        Giriş Yap
      </Link>
